...
public class RegisterUserServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//Call the DAO layer and save the user object to DB
		...
		if(rows == 0) {
			...
			infoMessage = "User Register successfully!";
		}
	...
	/**
	 * this methods reads HTML template as a String, replaces placeholders
